...
function init(prefix){inject_hover_for_element(document);var rpl=getReplyTo();rpl.setPrefix(prefix);var e=rpl.elem;e.setAttribute("draggable","true");e.ondragend=function(ev){var el=document.getElementById("postform_container");el.style.top=""+ev.y;el.style.left=""+ev.x;console.log(el);ev.preventDefault();}}
