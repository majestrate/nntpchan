...
DynReply.prototype.moveTo=function(x,y){x=document.body.clientLeft-x;if(x>0&&y>0&&x<document.body.clientWidth&&y<document.body.clientHeight){this.elem.setAttribute("style","top: "+y+"px; right: "+x+"px;");}}
