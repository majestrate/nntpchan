...
function init(prefix){inject_hover_for_element(document);var rpl=getReplyTo();var e=rpl.elem;e.setAttribute("draggable","true");e.ondragover=function(ev){console.log(ev);}}
